...
// The Finance panel exposes read-oriented views of the project, site-visit and
// document workflows scoped to the finance team.
const sidebarItems = [
  {
    category: 'Dashboard',
    items: [
    ...
    <>
      ...
      <div className="py-3 px-4 border-b border-gray-200">
        <div className="flex items-center justify-between">
          {showLabels && (
            <h2 className="text-lg font-semibold text-gray-900">Finance Panel</h2>
          )}
